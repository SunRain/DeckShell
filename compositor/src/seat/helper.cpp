...
void Helper::init()
{
    ...
    qmlRegisterSingletonInstance<ForeignToplevelV1>("DeckShell.Compositor.Protocols",
                                                   1,
                                                   0,
                                                   "ForeignToplevelV1",
    ...
    qmlRegisterUncreatableType<Personalization>("DeckShell.Compositor.Protocols",
                                                1,
                                                0,
                                                "Personalization",
                                                "Only for Enum");

    qmlRegisterUncreatableType<DDEShellHelper>("DeckShell.Compositor.Protocols",
                                               1,
                                               0,
                                               "DDEShellHelper",
                                               "Only for attached");
    qmlRegisterUncreatableType<CaptureSource>("DeckShell.Compositor.Protocols",
                                              1,
                                              0,
                                              "CaptureSource",
                                              "An abstract class");
