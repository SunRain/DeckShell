    ...
    , d_ptr(std::make_unique<TreelandPrivate>(this))
{
    ...
    qmlRegisterSingletonInstance("DeckShell",
                                 1,
                                 0,
                                 "TreelandConfig",
...
#if 0 // TODO: re-enable when greeter is ready
    auto userModel =
